...
import com.webperside.courseerpbackend.exception.NotFoundExceptionType;
        ...
        public static Meta of(BaseException ex) {
            if (ex.getResponseMessage().equals(NOT_FOUND)) {
                ...
                return of(
                        ...
                        String.format(ex.getResponseMessage().message(), notFoundData.getTarget().toLowerCase(), notFoundData.getFields().toString())
                );
            }
